; Простой конфигуратор Global Descriptor Table для архитектуры i386
; Изменения:
;   13 Nov, 18:32 :: Файл создан.
;   13 Nov, 18:47 :: Написан конфигуратор с минимальной документацией кода, взято из
;                    https://forum.nasm.us/index.php?topic=3887.0, с небольшим исправлением.
