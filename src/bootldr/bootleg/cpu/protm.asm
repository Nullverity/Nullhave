...
; Огромное спасибо: https://wiki.osdev.org/Protected_Mode
; Изменения:
...
;   13 Nov, 19:42 :: Изменена минимальная документация
;   13 Nov, 19:44 :: Добавлен адрес до ядра через `_KRNL_ADDR`, и прыжок в него в функции
;                    `initpm32`.
;   15 Nov, 14:24 :: Изменена документация

_KRNL_ADDR equ 0x10000

[bits 16]

jump_to_pm_msg db 0x0A, 0x0E, "Entering to protected mode...", 0x0
